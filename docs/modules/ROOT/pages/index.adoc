...
TIP: Upgrades Plugins are only a part of a comprehensive set of OpenZeppelin tools for upgradeable smart contracts. xref:openzeppelin::upgrades.adoc[Check out the full list of resources].

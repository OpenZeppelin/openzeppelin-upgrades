...
* `unsafeSkipStorageCheck`: (`boolean`) upgrades the proxy without first checking for storage layout compatibility errors. This is a dangerous option meant to be used as a last resort.

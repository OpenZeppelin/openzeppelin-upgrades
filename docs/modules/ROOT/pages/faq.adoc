...
Past versions of the plugins did not support upgradeable contracts that used custom types like structs or enums in their code or linked libraries. The current versions of the plugins do perform full automated checking of storage layout, including structs and enums. If you are not able to use them yet you may have to update your dependencies.

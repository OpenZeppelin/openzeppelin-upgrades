...
Given a previously deployed UUPS, Transparent, or Beacon proxy contract instance or a combination of proxy address and signer, returns an updated contract instance with the proxy address and its current implementation interface.

...
Same as <<defender-propose-upgrade>> but supports deploying the new implementation contract using the OpenZeppelin Platform. See xref:platform-deploy.adoc[Using with OpenZeppelin Platform].

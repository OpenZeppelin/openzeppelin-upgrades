...
* `proxyFactory`: (`ContractFactory`) Customizes the ethers ContractFactory to use for deploying the proxy, allowing a different proxy implementation. See https://github.com/OpenZeppelin/openzeppelin-upgrades/blob/master/packages/plugin-hardhat/src/utils/factories.ts[factories.ts] for the default factory for each kind of proxy.
** *Since:* `@openzeppelin/hardhat-upgrades@3.7.0`
* `deployFunction`: (`(hre, opts, factory, ...args) => Promise<EthersOrDefenderDeployment>`) Customizes the function used to deploy the proxy. See https://github.com/OpenZeppelin/openzeppelin-upgrades/blob/master/packages/plugin-hardhat/src/utils/deploy.ts[deploy.ts] for the default deploy function.
** *Since:* `@openzeppelin/hardhat-upgrades@3.7.0`

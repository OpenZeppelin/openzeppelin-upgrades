...
* `libraries`: (`{ [key: string]: string }`) When using OpenZeppelin Defender deployments, if your contract uses externally linked libraries, use this to provide a map of library names to their addresses.

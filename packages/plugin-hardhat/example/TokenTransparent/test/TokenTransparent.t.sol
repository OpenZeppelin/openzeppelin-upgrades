...
/**
 * @title TokenTransparentTest
 * @dev Foundry tests for the Transparent upgrade workflow: Ownable → AccessControl
 * 
 * These tests demonstrate:
 * 1. Deploying V1 with Ownable
 * 2. Upgrading to V2 with AccessControl
 * 3. State preservation during upgrade
 * 4. Access control functionality after upgrade
 */
contract TokenTransparentTest is Test {

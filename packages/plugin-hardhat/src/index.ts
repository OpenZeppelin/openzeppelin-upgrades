...
// async function makeFunctions(hre: HardhatRuntimeEnvironment, defender: boolean) {
//   const {
//     silenceWarnings,
//     getAdminAddress,
...
//     },
//     erc1967: {
//       getAdminAddress: (proxyAddress: string) => getAdminAddress(provider, proxyAddress),
//       getImplementationAddress: (proxyAddress: string) => getImplementationAddress(provider, proxyAddress),
//       getBeaconAddress: (proxyAddress: string) => getBeaconAddress(provider, proxyAddress),
//     },
//     beacon: {
//       getImplementationAddress: (beaconAddress: string) =>
//         getImplementationAddressFromBeacon(provider, beaconAddress),
//     },
//   };
// }

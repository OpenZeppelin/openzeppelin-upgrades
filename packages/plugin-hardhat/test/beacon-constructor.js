...
test('new beacon - do not redeploy with same args', async t => {
  ...
  const proxy1 = await upgrades.deployBeaconProxy(beacon1, WithConstructor, [], { initializer: false });
  ...
  const proxy2 = await upgrades.deployBeaconProxy(beacon2, WithConstructor, [], { initializer: false });

...

    {
      storage: [
        ...
        },
        {
          ...
          label: 'my_contract',
          src: 'file.sol:1',
          type: 't_contract(Storage2)1040',
        },
        {
          contract: 'Storage2',
          label: 'my_contract_dynarray',
          src: 'file.sol:1',
          type: 't_array(t_contract(Storage2)1040)dyn_storage',
        },
        {
          contract: 'Storage2',
          label: 'my_contract_staticarray',
          src: 'file.sol:1',
          type: 't_array(t_contract(Storage2)1040)10_storage',
        },
        {
          contract: 'Storage2',
          label: 'my_contract_mapping',
          src: 'file.sol:1',
          type: 't_mapping(t_uint256,t_contract(Storage2)1040)',
        },
        {
          contract: 'Storage2',
          label: 'my_contract_dynarray_mapping',
          src: 'file.sol:1',
          type: 't_mapping(t_uint256,t_array(t_contract(Storage2)1040)dyn_storage)',
        },
        {
          contract: 'Storage2',
          label: 'my_contract_staticarray_mapping',
          src: 'file.sol:1',
          type: 't_mapping(t_uint256,t_array(t_contract(Storage2)1040)10_storage)',
        },
        {
          contract: 'Storage2',
          label: 'my_struct',
          src: 'file.sol:1',
          type: 't_struct(MyStruct)996_storage',
        },
        {
          contract: 'Storage2',
          label: 'my_struct_dynarray',
          src: 'file.sol:1',
          type: 't_array(t_struct(MyStruct)996_storage)dyn_storage',
        },
        {
          contract: 'Storage2',
          label: 'my_struct_staticarray',
          src: 'file.sol:1',
          type: 't_array(t_struct(MyStruct)996_storage)10_storage',
        },
        {
          contract: 'Storage2',
          label: 'my_struct_mapping',
          src: 'file.sol:1',
          type: 't_mapping(t_uint256,t_struct(MyStruct)996_storage)',
        },
        {
          contract: 'Storage2',
          label: 'my_enum',
          src: 'file.sol:1',
          type: 't_enum(MyEnum)1012',
        },
        {
          contract: 'Storage2',
          label: 'my_enum_dynarray',
          src: 'file.sol:1',
          type: 't_array(t_enum(MyEnum)1012)dyn_storage',
        },
        {
          contract: 'Storage2',
          label: 'my_enum_staticarray',
          src: 'file.sol:1',
          type: 't_array(t_enum(MyEnum)1012)10_storage',
        },
        {
          contract: 'Storage2',
          label: 'my_enum_mapping',
          src: 'file.sol:1',
          type: 't_mapping(t_uint256,t_enum(MyEnum)1012)',
        },
        {
          contract: 'Storage2',
          label: 'my_complex_struct',
          src: 'file.sol:1',
          type: 't_struct(MyComplexStruct)1035_storage',
        },
        {
          contract: 'Storage2',
      ...
      types: {
        ...
        't_array(t_contract(Storage2)1040)10_storage': {
          label: 'contract Storage2[10]',
        },
        't_array(t_contract(Storage2)1040)dyn_storage': {
          label: 'contract Storage2[]',
        },
        't_array(t_enum(MyEnum)1012)10_storage': {
          label: 'enum Storage2.MyEnum[10]',
        },
        't_array(t_enum(MyEnum)1012)dyn_storage': {
        ...
        't_array(t_struct(MyStruct)996_storage)10_storage': {
          label: 'struct Storage2.MyStruct[10]',
        },
        't_array(t_struct(MyStruct)996_storage)dyn_storage': {
        ...
        't_mapping(t_uint256,t_array(t_contract(Storage2)1040)10_storage)': {
          label: 'mapping(uint256 => contract Storage2[10])',
        },
        't_mapping(t_uint256,t_array(t_contract(Storage2)1040)dyn_storage)': {
          label: 'mapping(uint256 => contract Storage2[])',
        },
        't_mapping(t_uint256,t_contract(Storage2)1040)': {
          label: 'mapping(uint256 => contract Storage2)',
        },
        't_mapping(t_uint256,t_enum(MyEnum)1012)': {
        ...
        't_mapping(t_uint256,t_struct(MyStruct)996_storage)': {
          label: 'mapping(uint256 => struct Storage2.MyStruct)',
        },
        t_string_storage: {
          label: 'string',
        },
        't_struct(MyComplexStruct)1035_storage': {
          label: 'struct Storage2.MyComplexStruct',
        },
        't_struct(MyStruct)996_storage': {
          label: 'struct Storage2.MyStruct',
        },
        t_uint256: {
          label: 'uint256',

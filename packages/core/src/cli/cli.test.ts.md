...
## validate - allow self reference by default (for backwards compatibility)

> Snapshot 1

    {
      stderr: '',
      stdout: ` ✔  contracts/test/cli/SelfReferences.sol:SelfReference (upgrades from contracts/test/cli/SelfReferences.sol:SelfReference)␊
      ␊
      SUCCESS␊
      `,
    }
